...
$("emptyState").hidden=filtered.length>0;renderPagination(page);$("metricTotal").textContent=notes.length;$("metricWeight").textContent=new Intl.NumberFormat("pt-BR").format(notes.reduce((s,n)=>s+(n.quantidade||0),0))}
