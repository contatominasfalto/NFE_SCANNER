const $=id=>document.getElementById(id);let notes=[],faturistas=[],filtered=[],auditLogs=[],refreshing=false,confirmCallback=null,pendingDeleteId=null,currentUser=null,tablePage=1,tablePageSize=100,tmeChart=null,tmacChart=null;
...
function renderTmacReport(result){
	...
	const days=result.dias||[];$("tmacChartEmpty").hidden=days.length>0;$("tmacChart").hidden=days.length===0;if(tmacChart){tmacChart.destroy();tmacChart=null}if(!days.length)return;
