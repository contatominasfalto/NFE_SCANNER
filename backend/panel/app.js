...
function closeDialog(id){const dialog=$(id);if(dialog?.open){dialog.close()}if(id==="reportsDialog")setModalMaximized("reportsModalSection",false);if(id==="tmeDialog")setModalMaximized("tmeModalSection",false)}
