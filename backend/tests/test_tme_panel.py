...
class TmePanelTests(unittest.TestCase):
    ...
    def test_tme_remains_outside_grouped_reports_menu(self):
        ...
        self.assertLess(reports_position, tmac_position)
        self.assertLess(tmac_position, tme_position)
    ...
    def test_tme_styles_and_cache_versions_are_present(self):
        ...
        self.assertRegex(self.html, re.compile(r"app\.js\?v=20260921-07"))
    ...
    def test_viewer_uses_report_and_note_download_permissions(self):
        ...
        self.assertIn("canDownloadXml=getPermissions().download", self.javascript)
        self.assertIn('viewer:["notes","reports","tme","tmac","tphb","tphe"]', self.javascript)
